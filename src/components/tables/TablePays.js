...
import ModalPays from "../DialogModal/ModalPays";
...
const TablePays= () => {
    ...
    const initialvalues = { nom: "",  zone_id: '',code:'' }
    ...
    const [datarow, setData] = useState([
        // {id:1, zone_id : 'Diallo', nom: 'Ibrahima', email : 'di84454@gmail.com', phone: '624 82 50 00'},
        // {id:2, zone_id : 'Barry', nom: 'moussa', email : 'di84454@gmail.com', phone: '624 82 50 00'},
        // {id:3, zone_id : 'Bangoura', nom: 'yagouba', email : 'di84454@gmail.com', phone: '624 82 50 00'},
        // {id:4, zone_id : 'Diallo', nom: 'Jeune', email : 'di84454@gmail.com', phone: '624 82 50 00'},
        // {id:5, zone_id : 'Bah', nom: 'Idiatou', email : 'di84454@gmail.com', phone: '624 82 50 00'},
    ])

    useEffect(() => {
        getDatarow()
    }, [])
    const url = `http://localhost:4000/pays`
    ...
    return (
        <div className="table-param">
            ...
            <ModalPays open={open} handleClose={handleClose} data={formData} onChange={onChange} handleSubmit={handleSubmit} />
