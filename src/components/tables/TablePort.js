...
import ModalPort from "../DialogModal/ModalPort";
...
const TablePort= () => {
    ...
    const initialvalues = { nom: "", geopoint_id: "", ville_id: '', password: "",code:'' }
    ...
    const [datarow, setData] = useState([
        // {id:1, ville_id : 'Diallo', nom: 'Ibrahima', email : 'di84454@gmail.com', phone: '624 82 50 00'},
        // {id:2, ville_id : 'Barry', nom: 'moussa', email : 'di84454@gmail.com', phone: '624 82 50 00'},
        // {id:3, ville_id : 'Bangoura', nom: 'yagouba', email : 'di84454@gmail.com', phone: '624 82 50 00'},
        // {id:4, ville_id : 'Diallo', nom: 'Jeune', email : 'di84454@gmail.com', phone: '624 82 50 00'},
        // {id:5, ville_id : 'Bah', nom: 'Idiatou', email : 'di84454@gmail.com', phone: '624 82 50 00'},
    ])
    ...
    return (
        <div className="table-param">
            ...
            <ModalPort open={open} handleClose={handleClose} data={formData} onChange={onChange} handleSubmit={handleSubmit} />
